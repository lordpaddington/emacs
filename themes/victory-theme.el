...
(let (
  ...
  (custom-theme-set-faces
   ...
   `(org-verbatim ((t (:foreground ,black :background ,butter-1))))
   ...
   `(org-date ((t (:inherit fixed-pitch :foreground ,orange-4))))
   `(org-date-selected ((t (:foreground ,white :background ,orange))))
   `(org-agenda-date ((t (:inherit org-date))))
   `(org-agenda-date-today ((t (:inherit org-date :weight bold))))
   `(org-agenda-date-weekend ((t (:inherit org-date :foreground ,magenta))))
   ...
   `(markdown-gfm-checkbox-face ((t (:inherit (fixed-pitch success) :weight bold))))
   `(markdown-inline-code-face ((t (:inherit (shadow fixed-pitch)))))
   `(markdown-blockquote-face ((t (:inherit shadow :foreground ,base6))))
