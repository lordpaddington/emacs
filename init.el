...
(custom-set-variables
 ...
 '(package-selected-packages
   '(org-bullets diminish ns-auto-titlebar markdown-mode+ markdown-preview-mode writeroom-mode markdown-mode sqlite3 key-chord magit solarized-theme doom-themes powerline-evil powerline doom-modeline which-key use-package smex simple-modeline restart-emacs counsel centered-cursor-mode auto-compile))
 '(save-place-mode t)
 '(show-paren-mode t)
 '(tool-bar-mode nil))
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(egoge-display-time ((((type x w32 mac)) (:foreground "white" :inherit bold)) (((type tty)) (:foreground "blue"))))
