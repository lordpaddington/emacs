...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ns-auto-titlebar markdown-mode+ markdown-preview-mode writeroom-mode markdown-mode sqlite3 key-chord magit solarized-theme doom-themes powerline-evil powerline doom-modeline which-key use-package smex simple-modeline restart-emacs counsel centered-cursor-mode auto-compile))
 '(save-place-mode t)
 '(show-paren-mode t)
 '(tool-bar-mode nil))
(custom-set-faces
